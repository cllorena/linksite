...
<a class="modal" title="Image" href="index.php?option=com_spidercatalog&task=media_manager_image&type=thumb&sel_img=<?php echo $key-1; ?>&tmpl=component" rel="{handler: 'iframe', size: {x: 550, y: 550}}">Select Image</a><br />
