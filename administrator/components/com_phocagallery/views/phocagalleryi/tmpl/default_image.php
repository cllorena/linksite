...
?><div class="phocagallery-box-file-i">
	...
	echo Joomla\CMS\HTML\HTMLHelper::_( 'image', $this->_tmp_img->linkthumbnailpath, '', array('width' => $image['width'], 'height' => $image['height']), '', null); ?></a>
					</center>
				</div>
			</div>
		</div>
	...
	<div class="name"><?php echo $this->_tmp_img->name; ?></div>
		<div class="detail" style="text-align:right">
			<a href="#" onclick="if (window.parent) window.parent.<?php echo $this->fce; ?>('<?php echo $this->_tmp_img->nameno; ?>');"><?php echo Joomla\CMS\HTML\HTMLHelper::_( 'image', 'media/com_phocagallery/images/administrator/icon-insert.gif', JText::_('COM_PHOCAGALLERY_INSERT_IMAGE'), array('title' => JText::_('COM_PHOCAGALLERY_INSERT_IMAGE'))); ?></a>
		</div>
...
?><div class="ph-item-box">
    <div class="ph-item-image"><a title="<?php echo $this->_tmp_img->name ?>" href="#" onclick="if (window.parent) window.parent.<?php echo $this->fce; ?>('<?php echo $this->_tmp_img->nameno; ?>');"><?php
            ...
            $imageRes	= PhocaGalleryImage::getRealImageSize($this->_tmp_img->nameno, 'medium');
	        $correctImageRes = PhocaGalleryImage::correctSizeWithRate($imageRes['w'], $imageRes['h'], 100, 100);
	        echo Joomla\CMS\HTML\HTMLHelper::_( 'image', $this->_tmp_img->linkthumbnailpath, '', array('width' => $image['width'], 'height' => $image['height']), '', null);
        ...
        <div class="ph-item-action-box">
			<a href="#" onclick="if (window.parent) window.parent.<?php echo $this->fce; ?>('<?php echo $this->_tmp_img->nameno; ?>');" title="<?php echo JText::_('COM_PHOCAGALLERY_INSERT_IMAGE') ?>"><span class="ph-cp-item"><i class="phi duotone phi-fs-m phi-fc-gd icon-download"></i></span></a></div>
</div>
