			...
			<form id="member-profile" action="<?php echo JRoute::_('index.php?option=com_users&task=profile.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
				...
				<?php foreach ($this->form->getFieldsets() as $group => $fieldset) : ?>
						...
						<fieldset class="uk-fieldset">
							<?php if (isset($fieldset->label)) : ?>
								<legend class="uk-legend">
									<h3 class="el-title uk-h4 uk-margin-small-top uk-margin-remove-bottom"><?php echo JText::_($fieldset->label); ?></h3>
								</legend>
							<?php endif; ?>
					...
					<?php if (count($this->twofactormethods) > 1) : ?>
						<fieldset class="uk-fieldset">
							<legend class="uk-legend"><?php echo JText::_('COM_USERS_PROFILE_TWO_FACTOR_AUTH'); ?></legend>
				...
				<div class="form-group uk-margin">
					...
					<a class="uk-button uk-button-secondary" href="<?php echo JRoute::_('index.php?option=com_users&view=profile'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
