...
$class    = isset($displayData['class']) ? $displayData['class'] : 'uk-button uk-button-secondary uk-button-small';
...
echo JHtml::_('bootstrap.renderModal',
	...
	array(
		...
		'bodyHeight'  => 60,
		'closeButton' => true,
		'footer'      => '<a class="uk-button uk-button-secondary" data-dismiss="modal" type="button"'
