...
<div data-target="#versionsModal" class="uk-button uk-button-secondary ml-2" data-toggle="modal" title="<?php echo $label; ?>">
	<span class="fas fa-archive" aria-hidden="true"></span> <?php echo $label; ?>
</div>
