...
$meta_style = $tmpl_params->get('blog_details_meta_style', 'sentence');
...
if ($params->get('show_category')) {
	...
	if ($params->get('link_category') && !empty($item->catid)) {
		$category = HTMLHelper::_('link', Route::_(ContentHelperRoute::getCategoryRoute($item->catslug)), $category);
	}
}
