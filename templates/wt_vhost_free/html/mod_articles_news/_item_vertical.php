...
?>
<div class="el-item uk-card uk-card-default uk-card-hover uk-display-block">
...
<div class="uk-card-body uk-margin-remove-first-child">
	...
	<?php if (isset($item->link) && $item->readmore != 0 && $params->get('readmore')) : ?>
		<?php echo '<p class="uk-margin-top"><a class="uk-button uk-button-primary" href="' . $item->link . '">' .JText::_('HELIX_ULTIMATE_READMORE_TEXT'). '</a></p>'; ?>
	<?php endif; ?>
	</div>
</div>