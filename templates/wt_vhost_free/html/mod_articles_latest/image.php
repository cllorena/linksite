...
?>
<div class="uk-child-width-1-1 uk-child-width-1-2@s uk-child-width-1-1@m uk-grid-small uk-grid-divider uk-grid-match" uk-grid>
    <?php
            ...
            <div class="el-item uk-panel uk-margin-remove-first-child">
                ...
                <div class="uk-child-width-expand uk-grid-small uk-flex-middle" uk-grid>
                    ...
                    <div class="uk-margin-remove-first-child">
                        ...
                        <div class="el-meta uk-text-meta uk-margin-small-top"><?php echo JHtml::_('date', $item->modified, JText::_('DATE_FORMAT_LC3')); ?></div>
                    </div>
                </div>
            </div>
        </div>
