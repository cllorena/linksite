...
*/
if((int)JRequest::getVar('cat_id',0) == 0){
...
//$page_num=JRequest::getVar('page_num', 1);
$cat_id=(int)JRequest::getVar('cat_id', 0);
...
$subcat_id=(int)JRequest::getVar('subcat_id',$cat_id);
...
$session->set( 'sel_categories', (int)JRequest::getVar('cat_id') );
