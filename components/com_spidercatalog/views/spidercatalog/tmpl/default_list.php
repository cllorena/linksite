...
if (!($row->image_url != "" and $row->image_url != ";"))
       echo '<td style="width:' . ($params->get('list_picture_width')+20). 'px;border-right: solid 1px #e8e8e8 !important;border-width:'.$params->get( 'border_width' ).'px;border-color:#'.$params->get( 'border_color' ).';border-style:'.$params->get( 'border_style' ).';border-top:none; border-left:none;"><img src="'.JURI::root().'/components/com_spidercatalog/images/noimage.jpg#'.$row->id.'" />
</td>';
else
{
				if(strpos($imgurl[0],'http://')===0 or strpos($imgurl[0],'https://')===0)
	...
	if($params->get('list_picture_width')=='')
				...
				$listwidth=$params->get('list_picture_width');
				  ...
				  echo '<td style="width:' . ($params->get('list_picture_width')+20). 'px;border-right: solid 1px #e8e8e8 !important;border-width:'.$params->get( 'border_width' ).'px;border-color:#'.$params->get( 'border_color' ).';border-style:'.$params->get( 'border_style' ).';border-top:none; border-left:none; "><a href="' . $imgurl[0] . '#'.$row->id.'" target="_blank"><img style=" margin:10px; width:' . $listwidth . 'px; height:' . $listheight . 'px;" src="index.php?option=com_spidercatalog&view=picture&format=raw&tmpl=component&id=' . $row->id . '&picnum=0&width=' . $listwidth . '&height=' . $listheight . '" /></a></td>';
				
		} else{
	if($params->get('list_picture_width')>=$params->get('list_picture_height'))
	
	 echo '<td style="width:' . ($params->get('list_picture_width')+20). 'px;border-right: solid 1px #e8e8e8 !important;border-width:'.$params->get( 'border_width' ).'px;border-color:#'.$params->get( 'border_color' ).';border-style:'.$params->get( 'border_style' ).';border-top:none; border-left:none;"><a href="' . $imgurl[0] . '#'.$row->id.'" target="_blank"><img style=" margin:10px" src="index.php?option=com_spidercatalog&view=picture&format=raw&tmpl=component&id=' . $row->id . '&picnum=0&width=' . $params->get('list_picture_width'). '" /></a></td>';
	 else{
