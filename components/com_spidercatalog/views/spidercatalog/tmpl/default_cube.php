...
else
{
	...
	if($params->get('single_cell_picture_width')=='')
				...
				$listwidth=$params->get('single_cell_picture_width');
				  ...
				  echo '<td style="padding-top: 25px !important;border-width:'.$params->get( 'border_width' ).'px;border-color:#'.$params->get( 'border_color' ).';border-style:'.$params->get( 'border_style' ).';border-top:none; border-left:none; "><a href="' . $imgurl[0] . '#'.$row->id.'" target="_blank"><img style="border: #CCC solid 2px; margin:10px; width:' . $listwidth . 'px; height:' . $listheight . 'px;" src="index.php?option=com_spidercatalog&view=picture&format=raw&tmpl=component&id=' . $row->id . '&picnum=0&width=' . $listwidth . '&height=' . $listheight . '" /></a></td>';
				
		} else{
	if($params->get('single_cell_picture_width')>=$params->get('single_cell_picture_height'))
	
	 echo '<td style="padding-top: 25px !important;border-width:'.$params->get( 'border_width' ).'px;border-color:#'.$params->get( 'border_color' ).';border-style:'.$params->get( 'border_style' ).';border-top:none; border-left:none;"><a href="' . $imgurl[0] . '#'.$row->id.'" target="_blank"><img  style="width:'.$params->get( 'single_cell_picture_width' ).'px;border: #CCC solid 1px; margin:10px" src="index.php?option=com_spidercatalog&view=picture&format=raw&tmpl=component&id=' . $row->id . '&picnum=0&width=' . $params->get('single_cell_picture_width'). '" /></a></td>';
	 else{
	   echo '<td style="padding-top: 25px !important;border-width:'.$params->get( 'border_width' ).'px;border-color:#'.$params->get( 'border_color' ).';border-style:'.$params->get( 'border_style' ).';border-top:none; border-left:none;"><a href="' . $imgurl[0] . '#'.$row->id.'" target="_blank"><img style="height:'.$params->get( 'single_cell_picture_height' ).'px;border: #CCC solid 2px; margin:10px" src="index.php?option=com_spidercatalog&view=picture&format=raw&tmpl=component&id=' . $row->id . '&picnum=0&height=' . $params->get('single_cell_picture_height'). '" /></a></td>';
	}
    }
