...
if ($params->get('enable_rating'))
	...
	if($params->get('cell_new_picture_width')=='')
        ...
        echo '<td style="vertical-align: middle !important;padding-right:15px;width:'.$params->get('cell_new_picture_width').'px;"><a href="' . $imgurl[0] . '#'.$row->id.'" target="_blank"><img style="width:' . $paramwidth . 'px; height:' . $paramheight . 'px;border:solid 1px #e5e5e5;" src="index.php?option=com_spidercatalog&view=picture&format=raw&tmpl=component&id=' . $row->id . '&picnum=0&width=170" /></a></td>';
		} else{
	if($params->get('cell_new_picture_width')>=$params->get('cell_new_picture_height'))
	
	 	  echo '<td style="vertical-align: middle !important;padding-right:15px;width:'.$params->get('cell_new_picture_width').'px;"><a href="' . $imgurl[0] . '#'.$row->id.'" target="_blank"><img  style="width:'.$params->get('cell_new_picture_width').'px;border:solid 1px #e5e5e5;" src="index.php?option=com_spidercatalog&view=picture&format=raw&tmpl=component&id=' . $row->id . '&picnum=0&width='.$params->get('cell_new_picture_width').'" /></a></td>';
	 else{
	  echo '<td style="vertical-align: middle !important;padding-right:15px;width:'.$params->get('cell_new_picture_width').'px;"><a href="' . $imgurl[0] . '#'.$row->id.'" target="_blank"><img style="height:'.$params->get('cell_new_picture_height').'px;border:solid 1px #e5e5e5;"  src="index.php?option=com_spidercatalog&view=picture&format=raw&tmpl=component&id=' . $row->id . '&picnum=0&height='.$params->get('cell_new_picture_height').'" /></a></td>';
	}
    }
	}
...
$small_images_str.='<a href="'.$img.'#'.$row->id.'" target="_blank"><img  style="width:70px;height:50px;border:solid 1px #e5e5e5;margin:2px;" src="index.php?option=com_spidercatalog&view=picture&format=raw&tmpl=component&id='.$row->id.'&picnum='.$key.'&height=50" vspace="0" hspace="0" ></a>
';
$small_images_count++;
}
}
