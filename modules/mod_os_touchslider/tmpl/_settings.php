...
?>
  ...
  <div id="dragable-settings-block<?php echo $module->id;?>" style="display:none">
    ...
    <ul id="os-tabs-<?php echo $module->id?>">
      <li class="slider-settings">
        ...
        <label data-tab-id="1" class="tab-label" for="tab1-<?php echo $module->id?>">Images<i class="os_icon-picture"></i></label>
          ...
          <div id="text-content-<?php echo $module->id?>">
            ...
            <div class="image-link-block">
              ...
              if(!empty($images)){
                ...
                foreach ($images as $image) {
                  ?>
                  <span data-image-id="<?php echo $image->id?>" class="image-link" style="display:none;">Image link:<i title="Add link for every whole image or you may add links to every text" class="os_icon-info-circled info_block"></i><input class="image-link-input" type="text" name="image-link[<?php echo $image->id?>]"  size="20" maxlength="300"
            ...
            <div class="image-background-block">
              ...
              if(!empty($images)){
                ...
                foreach ($images as $image) {
                  ...
                  ?>
                  <span data-image-id="<?php echo $image->id?>" class="image-background" style="display:none;">Background:<i title="To use, apply a transparency effect to the image or load a transparent image." class="os_icon-info-circled info_block"></i><input class="background-input custom_color_slide-<?php echo $module->id?>" data-image-id="<?php echo $image->id?>" type="text" name="image_background[<?php echo $image->id?>]" value="<?php echo $selected_background?>"></span>
                  <?php
                }
              }?>
              ...
              <div class="tab-edit-text">
                <ul id="os-text-tabs-<?php echo $module->id?>">
                  <li class="text-settings">
                    ...
                    <label id="text-label1-<?php echo $module->id?>" class="text-label" for="tab-text1-<?php echo $module->id?>">Text<i class="os_icon-text-width" aria-hidden="true"></i></label>
                  ...
                  <li class="text-settings">
                    ...
                    <label id="text-label2-<?php echo $module->id?>" class="text-label" for="tab-text2-<?php echo $module->id?>">Edit<i class="os_icon-pencil" aria-hidden="true"></i></label>
                  ...
                  <li class="text-settings">
                    ...
                    <label id="text-label3-<?php echo $module->id?>" class="text-label oss-pro-avaible" for="tab-text3-<?php echo $module->id?>">Block<i class="os_icon-indent-right" aria-hidden="true"></i></label>
                  ...
                  <div class="slider-images" data-sortable-id="<?php echo $image->id?>">
                    <div class="slider-image-block">
                      ...
                      <a class="edit-current-image" aria-invalid="false">
                        <i class="os_icon-pencil" aria-hidden="true"></i>
                      </a>
                       ...
                       <?php if(JFactory::getUser()->authorise('module.edit.frontend', 'com_modules.module.' . $module->id)){?>
                        <a class="copy-current-image oss-pro-avaible" aria-invalid="false">
                          <i class="os_icon-docs" aria-hidden="true"></i>
                        </a>
                      <?php }else{?>
                        <a class="copy-current-image oss-pro-avaible" aria-invalid="false">
                          <i class="os_icon-docs" aria-hidden="true"></i>
                      ...
                      <?php if(JFactory::getUser()->authorise('module.edit.frontend', 'com_modules.module.' . $module->id)){?>
                        <a class="replace-current-image oss-pro-avaible" aria-invalid="false">
                          <i class="os_icon-picture" aria-hidden="true"></i>
                        </a>
                      <?php }else{?>
                        <a class="replace-current-image oss-pro-avaible" aria-invalid="false">
                          <i class="os_icon-picture" aria-hidden="true"></i>
                      ...
                      <a class="delete-current-image" aria-invalid="false">
                        <i class="os_icon-cancel" aria-hidden="true"></i>
                      </a>
                      <?php }?>
      ...
      <li class="slider-settings">
        ...
        <label class="tab-label" data-tab-id="2" for="tab2-<?php echo $module->id?>">General<i class="os_icon-cogs"></i></label>
     ...
     <!--      <div class="option-block check-cover">
      ...
      <li class="slider-settings">
        ...
        <label class="tab-label  oss-pro-avaible" data-tab-id="4" for="tab4-<?php echo $module->id?>">Advanced<i class="os_icon-toggle-on"></i></label>
        <div id="tab-content4-<?php echo $module->id?>" class="tab-content animated fadeIn">
          ...
          <div class="hide-block  oss-pro-avaible" <?php echo ($params->get('effect') != 'slide' && $params->get('effect') != 'coverflow')?'style="display:none;"':''?>>
            ...
            <div>
              <div class="option-block">
                <span class="option-title">Slides per group:<i title="Set numbers of slides to define and enable group sliding. Useful to use with 'Slides per view' > 1" class="os_icon-info-circled info_block"></i></span>
                <span class="option">
          ...
          <div>
            <div class="option-block  oss-pro-avaible">
              <span class="option-title">Loop:<i title="This parameter works only if slidesPerView=1 and slidesPerColumn=1" class="os_icon-info-circled info_block"></i></span>
              <span class="option">
                <div class="checkbox-block">
      ...
      <li class="slider-settings">
        ...
        <label class="tab-label" data-tab-id="3" for="tab3-<?php echo $module->id?>">Animation<i class="os_icon-desktop"></i></i></label>
  ...
  <!-- end -->              
    ...
    <div class="copyright-block">OrdaSoft <a href="//ordasoft.com/os-touch-joomla-slider-responsive-joomla-slideshow.html" class="copyright-link" style="float:left;" title="Joomla Slider">Joomla Slider</a>, All rights reserved
